...
const MainContent = () => {
  return (
    <main className="flex-1 bg-[#F9F9F9] flex flex-col items-center justify-center p-8 text-center">
      <div className="max-w-lg flex flex-col items-center">
        {/* Illustration Placeholder */}
        <div className="relative mb-6 transform scale-110 mt-10">
        ...
        <button className="bg-[#111111] hover:bg-black text-white px-8 py-3 rounded-full flex items-center gap-3 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-gray-200">
